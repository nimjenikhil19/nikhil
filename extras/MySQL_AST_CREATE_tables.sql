...
INSERT INTO vicidial_statuses (status,status_name,selectable,human_answered,category,sale,dnc,customer_contact,not_interested,unworkable,scheduled_callback,completed) values('AM','Answering Machine Sent to Mesg','N','N','UNDEFINED','N','N','N','N','N','N','N');
...
UPDATE system_settings SET db_schema_version='1375',db_schema_update_date=NOW(),reload_timestamp=NOW();
