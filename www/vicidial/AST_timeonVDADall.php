...
##### NOT INBOUND ONLY ###
	...
	echo "<TD ALIGN=RIGHT><font size=2><B>DROPPED / $answers_text:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
